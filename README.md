...
# Monte Carlo Backtester A Monte Carlo simulation engine for backtesting trading strategies, built in python.
Supports multiple stochastic models for return simulation and computes standard
quantitative risk metrics.

## Models: - **Geometric Brownian Motion (GBM)** —> continuous diffusion baseline (Black-Scholes)
